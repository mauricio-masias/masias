                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                <td style="font-family:Arial,Helvetica,sans-serif;font-size:22px;font-weight:700;color:#ffffff;letter-spacing:-0.5px;">
                                                    MASIAS
                                                </td>
                                                <td width="10"></td>
                                                <td>
                                                    <!--[if mso]>
                                                    <v:oval xmlns:v="urn:schemas-microsoft-com:vml" style="width:8px;height:8px;position:relative;top:1px;" fillcolor="#64ffda" stroked="f"></v:oval>
                                                    <![endif]-->
                                                    <!--[if !mso]><!-->
                                                    <div style="width:8px;height:8px;background-color:#64ffda;border-radius:50%;display:inline-block;"></div>
                                                    <!--<![endif]-->
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td align="right">
                                        <p style="margin:0;font-family:'Courier New',Courier,monospace;font-size:10px;color:#444444;letter-spacing:1px;">{{ date('Y') }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="pad" bgcolor="#111111" style="background-color:#111111;border-left:1px solid #1f1f1f;border-right:1px solid #1f1f1f;padding:36px 40px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <tr>
                                    <td style="padding-bottom:{{ $loop->last ? '0' : '20px' }};">
                                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                {{-- Left accent bar --}}
                                                ...
                                                <td style="padding:16px 0;">
                                                    ...
                                                    <p style="margin:0 0 12px;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:1.6;color:#777777;">{{ $work->excerpt }}</p>
                                                    @if($work->url)
                                                    <a href="{{ $work->url }}" style="font-family:'Courier New',Courier,monospace;font-size:11px;color:#64ffda;text-decoration:none;letter-spacing:1px;">VIEW PROJECT &rarr;</a>
                                                    @else
                                                    <a href="{{ config('app.url') }}/works" style="font-family:'Courier New',Courier,monospace;font-size:11px;color:#64ffda;text-decoration:none;letter-spacing:1px;">VIEW WORKS &rarr;</a>
                                                    @endif
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                @if(!$loop->last)
                                <tr>
                                    <td style="padding-bottom:20px;border-bottom:1px solid #1a1a1a;font-size:0;line-height:0;">&nbsp;</td>
                                </tr>
                                @endif
                                @endforeach
                            </table>
                    ...
                    <tr>
                        <td bgcolor="#0d0d0d" style="background-color:#0d0d0d;border:1px solid #1f1f1f;border-top:none;padding:28px 40px;">
                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td>
                                        <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#555555;">{{ date('Y') }} &bull; Mauricio Masias</p>
                                    </td>
                                    <td align="right">
                                        <a href="mailto:{{ config('app.email') }}" style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#64ffda;text-decoration:none;">{{ config('app.email') }}</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
